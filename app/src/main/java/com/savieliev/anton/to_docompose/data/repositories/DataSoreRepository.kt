...
import com.savieliev.anton.to_docompose.util.Constants.PREFERENCE_KEY
import com.savieliev.anton.to_docompose.util.Constants.PREFERENCE_NAME
...
@ViewModelScoped
class DataSoreRepository @Inject constructor(
